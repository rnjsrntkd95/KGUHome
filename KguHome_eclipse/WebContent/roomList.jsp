    ...
    <div id="main">
        <div class="inner">
            ...
            <section>
                        ...
                        <%for(int i=0;i<list.size();i+=12){ %>
                         ...
                         <tr>
                            <td><%=list.get(i)%></td>
                             ...
                             <td><a href="roomRead.jsp?id=<%=list.get(i)%>"><%=list.get(i+1)%></a></td>
                            <td><%=list.get(i+3)%></td>
                            <td><%=list.get(i+4)%></td>
                            <td><%=list.get(i+5)%></td>
                                              			<td><a
													href="messageSend.jsp?nickname=<%=list.get(i+11)%>"><%=list.get(i + 11)%></a></td>
                        </tr> 
                        <%}%>
                        </tbody>
                    </table>
                ...
                <ul class="actions">
                    <li style="float: right"><a href="roomCreate.jsp" class="button special">작성하기</a></li>
                </ul>
