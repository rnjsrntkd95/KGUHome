							...
							<!-- Header -->
								<header id="header">
									...
									<% if(user_id == null){ %>
										...
										<% } else { %>
										<li><a href="MyPage.jsp" class="icon fa-cog"><span class="label">My Page</span></a></li>
										<li><a href="userLogout.jsp" class="icon fa-times"><span class="label">My Page</span></a></li>
										<% } %>
									</ul>
								</header>
